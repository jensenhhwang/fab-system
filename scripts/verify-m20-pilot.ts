...
async function main() {
  ...
  assert.equal(await equipmentMaster.countDocuments({ fabId: "M20" }), 329, "M20 Equipment Master 대수가 일치하지 않습니다");
  ...
  console.log(`✅ M20 agent ledger verified: ${workOrder._id}, 98kg, 8 events, 4 agents, 329 tools`);
  process.exit(0);
}
