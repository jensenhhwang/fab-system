...
| 시나리오 | 월 투입 WSPM | 현재 명목 대비 가동률 | NORMAL 대비 | 105일 고정 참조 WIP(FOUP-eq) | 계획 cycle time | 계획 WIP(FOUP-eq) | HBM4 12-Hi 환산/월 | 운영 판정 |
|---|---:|---:|---:|---:|---:|---:|---:|---|
...
- Route 기준: HBM4 12-Hi / P10 12회 / 총 134 모델 스텝
