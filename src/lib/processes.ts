...
export const PROCESSES: ProcessDef[] = [
  ...
  { code: "P08", name: "TSV/박막화",   nameEn: "TSV/Thinning",  color: "#EF4444", activities: ["관통 전극 형성", "조건부 Edge Trim", "Backgrind·TSV Reveal"], nMachines: 8  },
  { code: "P09", name: "웨이퍼테스트", nameEn: "Wafer Test",    color: "#84CC16", activities: ["전기 특성 검사", "수율 분석", "불량 맵핑"],            nMachines: 12 },
  { code: "P10", name: "패키징",       nameEn: "Packaging",     color: "#D946EF", activities: ["Dicing·Singulation", "제품별 Die Attach·적층", "MUF·몰딩·최종검사"], nMachines: 36 },
];
